...
# DEPRECATED: Deprecated: Use AccountModel instead
class LegacyAccount(ProtoBaseModel):
    """Пример deprecated модели
    ...
    code: str = Field(default="", max_length=32, json_schema_extra={"unique": True})
